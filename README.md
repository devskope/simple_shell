...
simple_shell is build in a `Ubuntu 14.04 LTS` linux environment and is to be compiled using the GNU compiler collection v. `gcc 4.8.4` with flags`-Wall, -Werror, -Wextra, and -pedantic.`

## Installation and use

   - Clone this repository: `git clone "https://github.com/devskope/simple_shell.git"`
...
## Authors
Devskope | [GitHub](https://github.com/devskope)
